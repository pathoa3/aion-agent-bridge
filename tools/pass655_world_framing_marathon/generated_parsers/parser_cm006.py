...
MODEL={'combined_model_id': 'cm006', 'frame_model_id': 'fm03412', 'header_size': '16', 'length_rule': 'off8_w1_little', 'message_type_field': '8', 'channel_field': 'candidate', 'body_start': '16', 'repeat_score': '0.625', 'channel_score': '1.0', 'parser_constraint_score': '0.875', 'negative_control_score': '0.5', 'total_score': '73.694', 'confidence': 'medium', 'reason': 'coherent model rank combining framing, field, repeat, channel, and existing parser constraints'}
def split(data):
