// Ghidra Java script: export recv/import wrapper xrefs for Pass634.
...
public class export_recv_import_wrappers extends GhidraScript {
    ...
    public void run() throws Exception {
        ...
        outDir = new File(args.length > 0 ? args[0] : "C:\\AionTools\\aion_decoder_agent\\outbox\\pass634_recv_import_wrappers");
        outDir.mkdirs();
